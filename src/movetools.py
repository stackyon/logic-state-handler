...
def build_move(move_code):
    ...
    from_x_y = coordinates(from_square)
    to_x_y = coordinates(to_square)
    new_movements.append(movement.Movement('up', from_x_y[0], from_x_y[1]))
    new_movements.append(movement.Movement('down', to_x_y[0], to_x_y[1]))
